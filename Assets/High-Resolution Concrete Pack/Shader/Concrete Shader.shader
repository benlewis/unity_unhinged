Shader "Concrete_Shader"
{
	Properties 
	{
_Diffuse("_Diffuse", 2D) = "gray" {}
_Normal("_Normal", 2D) = "bump" {}
_Glossyness("_Glossyness", Float) = 0.5
_Specular("_Specular", 2D) = "gray" {}
_Specularity("_Specularity", Float) = 1.6
...
float4 Multiply0=Tex2D2 * _Specularity.xxxx;
